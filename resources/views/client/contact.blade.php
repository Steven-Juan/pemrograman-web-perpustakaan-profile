<x-app-layout>
    ...
    <section class="contact-area-v3 pt-110 pb-120 light_bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title mb-65">
                        <span class="span">estimate</span>
                        <h2>Get In Touch</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form_group">
                                        ...
                                        <input type="text" class="form_control" placeholder="Enter your phone number"
                                            required>
                                ...
                                <div class="col-lg-12">
                                    <div class="form_group">
                                        <button class="main-btn" type="submit">Get A Quote</button>
                                    </div>
                                </div>
                            </div>
                        </form>
